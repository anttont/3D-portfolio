import {
  ...
  const introductions = [
    {
      fi:"Hei, olen Anttoni ja olen valmistunut tietojenkäsittelytieteen kandidaatti Itä-Suomen Yliopistosta. Haen työpaikkaa ohjelmistokehityksestä, jotta voin suorittaa maisteritutkinnon harjoittelun ja valmistua maisteriksi. Hallitsen ohjelmointikielet kuten JavaScriptin, Javan ja Pythonin. Olen viimeaikoina erityisesti opetellut web-kehitystä ja haluaisin hyödyntää taitojani haastavassa harjoittelupaikassa ohjelmistokehityksessä. Harjoittelupaikan saaminen antaisi minulle mahdollisuuden hankkia käytännön kokemusta ja osallistua todellisiin projekteihin. Samalla voisin suorittaa harjoitteluni, jota tarvitsen tutkintoani varten. Voit ottaa minuun yhteyttä sähköpostitse osoitteesta anttoni.tornikoski@gmail.com tai käyttämällä alla olevaa lomaketta.",
